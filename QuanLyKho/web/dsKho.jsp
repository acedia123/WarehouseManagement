        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Quản Lý Kho</h4>
                ...
                <div class="mb-3 d-flex align-items-center justify-content-between">
                    <a href="./addOrEditStore.jsp" class="btn btn-primary">Thêm kho mới</a>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <c:if test="${listStore.size() == 0}">
                            <tr>
                                <td colspan="4" class="text-center">Không có dữ liệu</td>
                            </tr>
                        </c:if>
                        <c:if test="${listStore.size() > 0}">
                            <c:forEach items="${listStore}" var="o">
                                <tr>
                                    <th class="align-middle" scope="row">${o.getMaKho()}</th>
                                    <td class="align-middle">${o.getTenKho()}</td>
                                    <td class="align-middle">${o.getDiaChi()}</td>
                                    <td class="align-middle">
                                        <span class="btn button-sm ${o.getTrangThai() == "1" ? "green":"red"}">${o.getTrangThai() == "1" ? "Hoạt động":"Không hoạt động"}</span>
                                    </td>
                                    <td class="align-middle d-flex">
                                        <a href="./AOUStore?id=${o.getMaKho()}" class="table-icon-btn">
